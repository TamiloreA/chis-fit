      ...
      <main>
        ...
        <section className="mission">
          <ScrollReveal className="mission-content">
            <h2>Our Mission</h2>
            <p>
              At CHI'S FIT, we believe that skincare should be a celebration
        ...
        <section className="founders">
          ...
          <ScrollReveal className="founders-content" delay={300}>
            <h2>The Founders</h2>
            <p>
              CHI'S FIT was born from a shared vision between two friends,
        ...
        <section className="process">
          <ScrollReveal className="process-content">
            <h2>Our Process</h2>
            <p>
              Every CHI'S FIT product begins with a question: What does your
              skin truly need?
            </p>
            <p>
